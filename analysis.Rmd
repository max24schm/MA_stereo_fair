...
data_long = melt(data, measure = patterns("Private_", "(a_g[1-9]|a_g[1-9][0-9])", "(b_g[1-9]|b_g[1-9][0-9])"), value.name = c("allocation", "group_a", "group_b"))
nrow(data_long[variable == 1]) # 267
data_long[,soc_group := variable] # TODO: validieren, dass 16 groups auch stimmen! wurden die in der richtigen reihenfolge untereinander aufgelistet?
