...
Variables from the 'Observed' condition were omitted
...
data<- data |> dplyr::select(!dplyr::contains("Observed")) # if R version below 4.1.0 is used, old pipe needs to be used here: %>% # exclude variables from 'observed' condition
